[![Build Status](https://travis-ci.org/bohni/maxdocs.svg?branch=master)](https://travis-ci.org/bohni/maxdocs)
...
It uses a branching model that is inspired by Vincent Driessen's model on his blog post at
